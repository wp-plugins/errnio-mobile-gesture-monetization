===Gesture Monetization by errnio===

Contributors: errnio
Tags: mobile, advertising, ad units, pay per click, PPC, monetise, monetize, gesture, advertizing, banners, make money, revenue, income, CPM, ads
...
Gesture based monetization tools for mobile sites, creating bannerless monetization.

== Description ==


The **Gesture Monetization** plugin from **errnio** adds a new revenue and engagement layer to your site with one simple installation. The plugin adds tools to enhance finger gestures on your mobile site, and improves user experience and monetization on your site, through unique search and content offers, with no banners.


For examples see the screenshot section or our demos at <a href="http://www.errnio.com/#products" target="_blank">www.errnio.com</a>
...
The **errnio plugin** reaches out to errnio servers and includes the errnio **gesture recognition code**. The gesture recognition code taps into your visitor gestures, performed on your site, and analyses which errnio monetization unit will work effectively with no banners or ads - choosing among the several units detailed above. errnio works with various 3rd party advertisers by connecting the right offers to the right gesture in the right context in and the right time - **ONLY** and **EXCLUSIVELY** within the errnio gesture functions. We never inject ads into your site!

Using the unique **errnio** plugin maximizes your full monetization potential on mobile web with no banners. To be eligible for our revenue program please make sure register with us.
...
5. You should receive a notification on your dashboard for additional instructions.
...
**1.2 Register to errnio directly from the plugin settings page
